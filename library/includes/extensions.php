	...
	function widget($args, $instance)
	{
		...
		<ul class="social-buttons clearfix">
			...
			<?php } if(of_get_option('tiga_tumblr_username')) { ?>
				<li><a href="http://<?php echo esc_attr( of_get_option('tiga_tumblr_username') ); ?>.tumblr.com" target="_blank"><img src="<?php echo get_template_directory_uri(). '/library/img/icons/tumblr.png'; ?>"></a></li>
			<?php } if(of_get_option('tiga_instagram_username')) { ?>
				<li><a href="http://statigr.am/<?php echo esc_attr( of_get_option('tiga_instagram_username') ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(). '/library/img/icons/instagram.png'; ?>"></a></li>
			<?php } ?>
		</ul>
